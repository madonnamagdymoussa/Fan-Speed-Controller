...
/* Version: V1                                                                                        */
/* Usage: This module contains the interface definitions for the dio peripheral                       */
/******************************************************************************************************/
...
/************************************************************************/
#include"lstd.h"
#include "dio_hardware_registers.h"
...
/*
 *  Defines the number of ports on the pre-processor
 */

#define Number_OF_PORTS              (4)

/*
 *  Defines the number of channels per port
 */
...
/*
 * Defines the possible states for a digital  pin
 */
 ...
 *
 * Description : This function is responsible for writing a value in the PORT register
 * *
